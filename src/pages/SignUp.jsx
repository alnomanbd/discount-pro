      ...
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6 relative">
            ...
            >
              {passwordVisible ? <FaEyeSlash className="text-xl" /> : <FaEye className="text-xl" />}
            </button>
          </div>
          ...
          <div className="mb-6 relative">
            ...
            <button
              ...
              className="absolute top-14 right-3 transform -translate-y-1/2 text-gray-500"
            >
              {confirmPasswordVisible ? <FaEyeSlash className="text-xl" /> : <FaEye className="text-xl" />}
            </button>
          </div>
          ...
          <div className="mb-6 flex items-center justify-between">
            <div className="flex items-center">
              ...
              <label htmlFor="terms" className="text-sm text-gray-600">
                I agree to the <a href="/auth/terms" className="text-blue-600 hover:text-blue-800">terms and conditions</a>
              </label>
            </div>
          </div>
          ...
          <button
            type="submit"
            className={`w-full py-2 ${iAgree ? 'bg-blue-600' : 'bg-gray-400'} text-white font-semibold rounded-lg hover:bg-blue-700 transition duration-200`}
